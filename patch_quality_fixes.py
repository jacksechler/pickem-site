...
s=s.replace('<script src="app_update.js?v=1"></script>','<script src="app_update.js?v=3"></script>')
s=s.replace('<script src="app_update.js?v=2"></script>','<script src="app_update.js?v=3"></script>')
